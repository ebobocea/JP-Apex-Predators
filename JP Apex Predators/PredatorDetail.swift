...
struct PredatorDetail: View {
    ...
    struct PredatorDetail_Preview: PreviewProvider {
        static var previews: some View {
            ...
            let predator = ApexPredator(id: 1, name: "Brachiosaurus", type: "land", movies: ["Jurassic Park"], movieScenes: [movieScene1, movieScene2], link: "https://jurassicpark.fandom.com/wiki/Brachiosaurus")
