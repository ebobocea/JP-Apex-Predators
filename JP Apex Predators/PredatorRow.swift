...
struct PredatorRow_Previews: PreviewProvider {
    static var previews: some View {
        ...
        PredatorRow(predator: ApexPredator(id: 1, name: "Brachiosaurus", type: "land", movies: ["Jurassic Park"], movieScenes: [movieScene], link: "https://jurassicpark.fandom.com/wiki/Brachiosaurus"))
